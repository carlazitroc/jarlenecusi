...
var apiURLPrefix = '<?php echo base_url('file');?>';
...
$('.upload form.ifrm').ifrm({
	onSubmit:function(){
        ...
        $('.filedrop').addClass('filedrop-uploading');
	...
	onError: function(){
        $('.filedrop').removeClass('filedrop-uploading');
...
$('.filedrop').each(function(){
	...
	$self.filedrop({
	    ...
	    url: config.site_url+'file/upload.json',              // upload handler, handles each file separately, can also be a function taking the file and returning a url
	    ...
	    dragOver: function() {
	        ...
	        $self.addClass('filedrop-dnd');
	    },
	    dragLeave: function() {
	        // user dragging files out of #dropzone
	        $self.removeClass('filedrop-dnd');
	    },
	    drop: function() {
	        // user drops file
	        $self.removeClass('filedrop-dnd');
	    ...
	    uploadStarted: function(i, file, len){
	        ...
	        $self.addClass('filedrop-uploading');
	    },
	    ...
	    afterAll: function() {
	        ...
	        $self.removeClass('filedrop-uploading');
	    }
	});
});
