...
$this -> asset -> js_embed($view_path_prefix.'_index.js.php',NULL,NULL,'body_foot');
...
<div class="modal-footer float">
	...
	<button type="button" class="btn btn-item-select btn-primary" disabled="disabled"><i class="fa fa-check"></i> <?php echo lang('button_done')?></button>
</div>
<div class="modal-body">
<?php } ?>


	<div class="row record-list" rl-select-button=".btn-item-select">
<?php if(!$is_dialog){ ?>
		<div class="col-xs-12">
			<div class="page-header">
				<div class="pull-right"><a href="<?php echo $endpoint_url_prefix.('/add')?>" class="btn btn-info"><i class="fa fa-plus"></i> <?php echo lang('button_add')?></a></div>
...
<?php } ?>
			...
			<div class="table-responsive">
				<table class="table cell-list table-striped table-hover table-condensed ">
					...
					<tbody>
						<tr class="template">
							<td><div class="row-caption"><span rc-text="sys_name"></span>, <span rc-text="loc_title"></span> </div>
								<div class="extra-tools">
								<div class="btn-group">
									<label class="btn btn-xs btn-default btn-select rc" rc-data-id="id"><i data-deactive="fa-circle-o" data-active="fa-dot-circle-o" class="fa fa-circle-o"></i></label>
								</div>
								<div class="btn-group">
									<a href="#" rc-href="'<?php echo $endpoint_url_prefix?>/'+row.id+'/edit'" class="btn btn-default btn-xs"><?php echo lang('button_edit')?></a>
								</div>
							</td>
						<td><small><span rc-text="is_pushed_str"></span><small>, <span rc-date-format="ago" rc-text="last_pushed"></span></small></small></td>
