...
$this->asset->js_embed('user/admin/role_relationship_editor.js.php', compact('element_id'), NULL, 'body_foot');
?>

<div hc-elm="<?php echo $element_id?>">
	<div class="list-group-add">
		<button class="btn btn-default" type="button">
		<?php echo lang('button_add_role')?>
		</button>
	</div>
	...
	<thead>
		<tr>
			...
			<th class="col-xs-6"><?php echo lang('field_role_id')?></th>
	...
	<script type="text/x-javascript-template" data-template="row">
		<tr>
			...
			<td><span rr-text="role_name"></span></td>		
				<td><span rr-text="!row.start_date? 'N/A' : row.start_date"></span></td>
				<td><span rr-text="!row.end_date ? 'N/A' : row.end_date"></span></td>
			<td>
			<span rr-if="status != '1'" class="label label-info"><?php echo lang('status_0')?></span>
			<span rr-if="status == '1'" class="label label-success"><?php echo lang('status_1')?></span>
			</td>
		</tr>
	</script>

	<div hc-dialog-template="role-form" class="modal">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">

	       			<h4 class="modal-title">Role Option</h4>
				</div>
				<div class="modal-body">
					<form class="form" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<?php echo form_dropdown('',array('0'=>'Disabled','1'=>'Enabled'),'1', ' class="form-control" hc-value="status"') ?>
						</div>
					</form>
				</div>
